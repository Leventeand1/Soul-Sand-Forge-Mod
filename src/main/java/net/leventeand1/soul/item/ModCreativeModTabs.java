...
@Mod.EventBusSubscriber(modid = SoulMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModCreativeModTabs {
    public static CreativeModeTab ADVANCED_SOUL_SAND;

    @SubscribeEvent
    public static void registerCreativeModeTabs(CreativeModeTabEvent.Register event) {
       ADVANCED_SOUL_SAND = event.registerCreativeModeTab(new ResourceLocation(SoulMod.MOD_ID, "soul_tab"),
